          ...
          <table className="userTable curve0022">
            <tbody>
                ...
                <td className="value">
                  <p>
                    ...
                    >
                      ...
                      <option value="CG">Congo, People's Rep. of</option>
                ...
                <td className="value">
                  <p>
                    ...
                    >
                      ...
                      <option value="Africa/Lome">(GMT+0:00) GMT - Lome</option>
                      ...
                      <option value="Asia/Gaza">(GMT+3:00) EEST - Gaza</option>
                      ...
                      <option value="Asia/Aden">(GMT+3:00) AST - Aden</option>
                      ...
                      <option value="Africa/Juba">(GMT+3:00) EAT - Juba</option>
                      ...
                      <option value="Asia/Qatar">(GMT+3:00) AST - Qatar</option>
                      ...
                      <option value="Asia/Baku">(GMT+4:00) AZT - Baku</option>
                      <option value="Asia/Dubai">(GMT+4:00) GST - Dubai</option>
                      <option value="Indian/Mahe">(GMT+4:00) SCT - Mahe</option>
                      ...
                      <option value="Asia/Kabul">(GMT+4:30) AFT - Kabul</option>
                      ...
                      <option value="Asia/Oral">(GMT+5:00) ORAT - Oral</option>
                      ...
                      <option value="Asia/Dacca">(GMT+6:00) BDT - Dacca</option>
                      <option value="Asia/Dhaka">(GMT+6:00) BDT - Dhaka</option>
                      <option value="Asia/Kashgar">
                        (GMT+6:00) XJT - Kashgar
                      </option>
                      <option value="Asia/Omsk">(GMT+6:00) OMST - Omsk</option>
                      ...
                      <option value="Asia/Hovd">(GMT+7:00) HOVT - Hovd</option>
                      ...
                      <option value="Asia/Macao">(GMT+8:00) CST - Macao</option>
                      <option value="Asia/Macau">(GMT+8:00) CST - Macau</option>
                      ...
                      <option value="Asia/Dili">(GMT+9:00) TLT - Dili</option>
                      ...
                      <option value="Asia/Seoul">(GMT+9:00) KST - Seoul</option>
                      <option value="Asia/Tokyo">(GMT+9:00) JST - Tokyo</option>
              ...
              <tr>
                ...
                <td className="value">
                  <p>
                    ...
                    <select name="bYear" id="bYear" onchange="__yearChanged()">
                      <option value>-Select-</option>
              ...
              <tr className="hide">
                ...
                <td className="value">
                  <p>
                    Receive email updates for Fantrax news, promotions, etc.
                  </p>
                </td>
              </tr>
              <tr className="hide">
                ...
                <td className="value">
                  <p>Receive email updates for scores, standings, etc.</p>
                </td>
              </tr>
            </tbody>
          </table>
